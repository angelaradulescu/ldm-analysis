...
def plotAOIFeatures(subj_id, block, trial):
    ...
    return makePlot(this_trial_featmap, block_centers, indices, labels, xdim, ydim)

def makePlot(trial_featmap, block_centers, indices, labels, xdim, ydim, height=3, ticks=False, cmap=None):
    ## Initialize plot.
